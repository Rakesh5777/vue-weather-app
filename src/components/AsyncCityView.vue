...
const removeCity = () => {
  const allCities: any[] = JSON.parse(localStorage.getItem("savedCities")!);
  localStorage.setItem(
    "savedCities",
    JSON.stringify(allCities.filter((city) => city.id != route.query.id))
  );
