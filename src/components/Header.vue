<template>
  <header class="sticky top-0 shadow-lg bg-weather-primary">
    ...
    >
      ...
      <BaseModal :modalState="modalState" @close-modal="toggleState">
        <div class="text-black">
          ...
          <ol class="list-decimal list-inside mb-4">
            ...
            <li>
              Click on The Local Weather logo to redirect to home screen.
            </li>
            <li>
...
const toggleState = () => (modalState.value = !modalState.value);
